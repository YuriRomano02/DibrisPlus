...
<body>
    ...
    <div class="elementi">
        ...
        <h1>Nome film</h1><i class="fa-regular fa-heart preferiti"></i><br>



        <div class="informazioni">
            <iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=MJb0qPYp7nhe8moR&rel=0"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen></iframe>

            <img src="immagine del film">
        </div>
